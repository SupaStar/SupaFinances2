...
extension StockEntity {
    ...
    @NSManaged public var desired_titles: Double
    @NSManaged public var name: String?
    @NSManaged public var price_prom: Double
    @NSManaged public var quantity: Double
    @NSManaged public var symbol: String?
    @NSManaged public var value: Double
    @NSManaged public var week_ammount: Double
    @NSManaged public var last_price: Double
    @NSManaged public var modify_date: Date?
